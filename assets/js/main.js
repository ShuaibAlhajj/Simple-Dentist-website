document.addEventListener('DOMContentLoaded', () => {
  ...
  const setActiveNav = () => {
    ...
    // Select nav links in both desktop nav and mobile menu
    const navLinks = document.querySelectorAll('nav a, [data-nav-menu] a');
    navLinks.forEach((a) => {
      ...
      if (isActive) {
        ...
        // Remove potentially conflicting hardcoded classes
        a.classList.remove('text-slate-600', 'text-brand-500', 'font-medium', 'font-semibold');
      } else {
